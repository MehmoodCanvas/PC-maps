    ...
    <div class="top_db_btn">
            ...
            <nav id="menu">
                ...
                <div class="scroll_container">
                    ...
                    <div class="hi_box">
                        <h1 class="heading">CHOOSE MAP SIZE</h1>
                    ...
                    <div class="hi_box">
                        <h1 class="heading">ADD COMPASS?</h1>
                        <div class="form_group_input">
                            <label class="material-checkbox">
                                <input type="checkbox" name="compasss" value="compasss" id="compasss-add">
                                <span class="checkmark">Add Compass</span>
                            </label>
                        </div>
                    </div>
                    <div class="hi_box">
                        <h1 class="heading">ADD ON'S?</h1>
                        <div class="form_group_input check_1">
                            <label class="material-checkbox">
                                <input type="checkbox" name="add_on" id="add-on">
                                <span class="checkmark">Add On</span>
                            </label>
                        </div>
                        <div class="form_group_input check_2">
                            <label class="material-checkbox">
                                <input type="checkbox" name="" id="wooden-on">
                                <span class="checkmark">Additional Wooden Frame</span>
                            </label>
                        </div>
                    </div>
                    <div class="hi_box">
                        <h1 class="heading">ADD TEXT?</h1>
                    ...
                    <div class="hi_box">
                        <h1 class="heading">SEARCH LOCATION</h1>
